            ...
            <div className="flex flex-wrap mt-8 justify-between">
                {taskData.map((ele, index) => (
                    <div className="mt-4 w-full lg:w-2/12 xl:w-4/20 px-5 mb-4" key={index}>
                        <div className="relative flex flex-col min-w-0 break-words bg-white rounded mb-3 xl:mb-0 shadow-2xl">
                            <div className="flex-auto p-4">
                                <div className="flex flex-wrap">
                                    ...
                                    <div className="relative w-auto pl-4 flex-initial">
                                        <div
                                            className={`text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 shadow-lg rounded-full  bg-${ele.color}-500`}>
                                            {ele.icon}
                                        </div>
                                    </div>
                                </div>
